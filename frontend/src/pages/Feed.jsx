...
const navigate = useNavigate();
  ...
  useEffect(() => {
    const fetchPosts = async () => {
      try {
        const res = await axios.get("https://linkedclone-backend.onrender.com/api/posts");
    ...
    const fetchUser = async () => {
      try {
        ...
        const res = await axios.get("https://linkedclone-backend.onrender.com/api/users/me", {
  ...
  const handlePost = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(
        "https://linkedclone-backend.onrender.com/api/posts",
        {  text : content },
        {
          headers: {
...
const handleLike = async (postId) => {
  try {
    ...
    const res = await axios.put(
      `https://linkedclone-backend.onrender.com/api/posts/${postId}/like`,
      {},
      {
        headers: { Authorization: `Bearer ${token}` },
      }
